...
{{text("We are able to upload writeups, but not <code class='bg-gray-300 rounded-md px-1'>php</code> files. After testing, I discovered that <code class='bg-gray-300 rounded-md px-1'>shell.png.php</code> goes through, but the <code class='bg-gray-300 rounded-md px-1'>php</code> file still doesn't get executed.")}}
